...
The example dataset steam_subset.csv can be downloaded [here](https://raw.githubusercontent.com/HumbleLu/IntroR/master/steam_subset.csv). The colums are seperated with comma( , ) and the first line is the column names.
