...
2. Write a for loop to sum up all the elements of a vector, compare time comsumtio to simply using the function `sum`. Use the function `Sys.time()` to record the time, for example:
```{r, eval=F}
start_t<- Sys.time()
